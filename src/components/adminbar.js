  ...
  return (
    <>
      ...
      <div className={`sidebar ${inactive ? "inactive" : ""}`}>
        <IconContext.Provider value={{ className: "leftnav_icons" }}>
          <div>
            <p>
              <MdOutlineDashboard />
            </p>
          ...
          <div>
            ...
            <Link to="/admin/add">Add Mentor +</Link>
          </div>
